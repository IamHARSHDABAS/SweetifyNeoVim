...
local DEFAULT_CONFIG = {
   ...
   colors = require("sweetify.palette"),
   overrides = {},
}
...
---load sweetify colorscheme
local function load()
   if vim.version().minor < 7 then
      vim.notify_once("sweetify.nvim: you must use neovim 0.7 or higher")
      return
   end
